...
public abstract class Request<T> implements Comparable<Request<T>> {
    ...
    protected WJHttp mRequestQueue;
    ...
    public Request<?> setRequestQueue(WJHttp requestQueue) {
     ...
     */
    protected WJHttpException parseNetworkError(WJHttpException volleyError) {
        return volleyError;
    }
     ...
     * @param error 原因
     */
    public void deliverError(WJHttpException error) {
        if (mCallback != null) {
            int errorNo;
            String strMsg;
            if (error != null) {
