...
import com.wj.android.wjframe.http.HttpHeaderParser;
import com.wj.android.wjframe.http.WJHttpException;
import com.wj.android.wjframe.http.NetworkResponse;
import com.wj.android.wjframe.http.Request;
import com.wj.android.wjframe.http.Response;
...
public class ImageRequest extends Request<Bitmap> implements Persistence {
    ...
    public Response<Bitmap> parseNetworkResponse(NetworkResponse response) {
        synchronized (sDecodeLock) {
            try {
                ...
                WJLoger.debug("Caught OOM for %d byte image, url=%s",
                        response.data.length, getUrl());
                return Response.error(new WJHttpException(e));
            }
        }
    }
    ...
    private Response<Bitmap> doParse(NetworkResponse response) {
        ...
        if (bitmap == null) {
            return Response.error(new WJHttpException(response));
        } else {
