...
public class HttpConnectStack implements HttpStack {
    ...
    @Override
    public WJHttpResponse performRequest(Request<?> request,
        ...
        WJHttpResponse response = responseFromConnection(connection);
        return response;
    }

    private WJHttpResponse responseFromConnection(HttpURLConnection connection) throws IOException {
        WJHttpResponse response = new WJHttpResponse();
        //contentStream
