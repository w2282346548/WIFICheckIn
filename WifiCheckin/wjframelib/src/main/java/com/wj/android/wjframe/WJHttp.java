...
import com.wj.android.wjframe.http.CacheDispatcher;
import com.wj.android.wjframe.http.DownloadController;
import com.wj.android.wjframe.http.DownloadTaskQueue;
import com.wj.android.wjframe.http.FileRequest;
import com.wj.android.wjframe.http.FormRequest;
...
import com.wj.android.wjframe.http.JsonRequest;
import com.wj.android.wjframe.http.NetworkDispatcher;
import com.wj.android.wjframe.http.Request;
...
public class WJHttp {
    ...
    public WJHttp(HttpConfig config) {
        if (config == null) {
    ...
    public static class Builder {
        ...
        public void request() {
            request(new WJHttp(httpConfig));
        }

        public void request(WJHttp kjHttp) {
            switch (httpMethod) {
    ...
    public <T> Request<T> add(Request<T> request) {
        ...
        synchronized (mWaitingRequests) {
            ...
            if (mWaitingRequests.containsKey(cacheKey)) {
                ...
                if (HttpConfig.DEBUG) {
                    WJLoger.debug("Request for cacheKey=%s is in flight, putting on hold.",
                            cacheKey);
                }
            } else {
        ...
        if (request.shouldCache()) {
            synchronized (mWaitingRequests) {
                ...
                if (waitingRequests != null) {
                    if (HttpConfig.DEBUG) {
                        WJLoger.debug("Releasing %d waiting requests for cacheKey=%s.",
